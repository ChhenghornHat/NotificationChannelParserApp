...
$(function () {
    let e, s, n
    n = (isDarkStyle
        ? (e = config.colors_dark.borderColor, s = config.colors_dark.bodyBg, config.colors_dark)
        : (e = config.colors.borderColor, s = config.colors.bodyBg, config.colors)).headingColor
    var t = $('.datatables-products'), a = {
    ...
    t.length && (t.DataTable({
        ...
        columnDefs: [
            {
                ...
                targets: 0,
                render: function (t, e, s, n) {return ''},
            },
            {
                targets: 1,
                orderable: !1,
            ...
            },
            {
                ...
                render: function (t, e, s, n) {
                    var a = s.product_name, i = s.id, o = s.product_brand,
                        c = s.image
                    return '<div class="d-flex justify-content-start align-items-center product-name"><div class="avatar-wrapper me-3"><div class="avatar rounded-2 bg-label-secondary">' +
                        (c
                            ? '<img src="' + assetsPath +
                            'img/ecommerce-images/' + c + '" alt="Product-' +
                            i + '" class="rounded-2">'
                            ...
                            [
                                ...
                                'dark',
                                'primary',
                                'secondary'][Math.floor(6 * Math.random())] +
                            '">' +
                            (c = (((c = (a = s.product_brand).match(/\b\w/g) ||
                                    []).shift() || '') +
                                (c.pop() || '')).toUpperCase()) + '</span>') +
            ...
            },
            {
                ...
                render: function (t, e, s, n) {
                    ...
                    return '<h6 class=\'text-truncate d-flex align-items-center mb-0\'>' +
                        {
                            Household: '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-warning me-2"><i class="mdi mdi-home-outline"></i></span>',
                            ...
                            Electronics: '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-primary me-2"><i class="mdi mdi-cellphone"></i></span>',
                            ...
                            Accessories: '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-secondary me-2"><i class="mdi mdi-watch"></i></span>',
            ...
            },
            {
                ...
                render: function (t, e, s, n) {
                    ...
                    return '<span class=\'text-truncate\'>' + {
                        ...
                        }[o[s].title] + '<span class="d-none">' + o[s].title +
                        '</span></span>'
                },
            },
            {
            ...
            {
                targets: -2, render: function (t, e, s, n) {
                    s = s.status
                    return '<span class="badge ' + a[s].class +
                        '" text-capitalized>' + a[s].title + '</span>'
                },
            },
            {
                targets: -1,
                ...
                render: function (t, e, s,
                    n) {return '<div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon"><i class="mdi mdi-pencil-outline"></i></button><button class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical me-2"></i></button><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:0;" class="dropdown-item">View</a><a href="javascript:0;" class="dropdown-item">Suspend</a></div></div>'},
            }],
        order: [2, 'asc'],
        ...
        buttons: [
                ...
                buttons: [
                    {
                        ...
                        exportOptions: {
                            ...
                            format: {
                                body: function (t, e, s) {
                                    var n
                                    return t.length <= 0 ? t : (t = $.parseHTML(
                                        t), n = '', $.each(t, function (t, e) {
                                        void 0 !== e.classList &&
                        ...
                        customize: function (t) {
                            $(t.document.body).
                                css('color', n).
                                css('border-color', e).
                                css('background-color', s), $(t.document.body).
                                find('table').
                                addClass('compact').
                                css('color', 'inherit').
            ...
            },
            {
                ...
                action: function () {window.location.href = 'app-ecommerce-product-add.html'},
            }],
        responsive: {
            details: {
                ...
                renderer: function (t, e, s) {
                    s = $.map(s, function (t, e) {
                        return '' !== t.title
                            ? '<tr data-dt-row="' + t.rowIndex +
                            '" data-dt-column="' + t.columnIndex + '"><td>' +
                            t.title + ':</td> <td>' + t.data + '</td></tr>'
                            : ''
                    }).join('')
            ...
            this.api().
                ...
                every(function () {
                    ...
                    e.data().
                        ...
                        sort().
                        each(function (t, e) {
                            s.append('<option value="' + a[t].title + '">' +
                                a[t].title + '</option>')
                        })
                }), this.api().
                columns(3).
                every(function () {
                    ...
                    e.data().
                        ...
                        sort().
                        each(function (t, e) {
                            s.append('<option value="' + i[t].title + '">' +
                                i[t].title + '</option>')
                        })
                }), this.api().
                columns(4).
                every(function () {
                    ...
                    e.data().
                        ...
                        sort().
                        each(function (t, e) {
                            s.append('<option value="' + o[t].title + '">' +
                                c[t].title + '</option>')
                        })
                })
        },
    }), $('.dataTables_length').addClass('mt-0 mt-md-3'), $(
        '.dt-action-buttons').addClass('pt-0')), setTimeout(() => {
